...
You probably already have a few questions in mind
...
{{< figure src="/images/0002-example3.png" align=center title=">Pretty sneaky!" alt="Screenshot of the terminal containing cocker autocomplete usage, showing arguments from docker command">}}
